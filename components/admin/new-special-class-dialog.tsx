...
import { createSpecialClass } from "@/lib/actions/admin"
import { toast } from "sonner"

export function NewSpecialClassDialog() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await createSpecialClass(formData)
      toast.success("Clase especial creada exitosamente")
      setOpen(false)
      setModality("")
      // Reset form
      ...
      toast.error(error instanceof Error ? error.message : "Error al crear la clase especial")
    } finally {
      setIsLoading(false)
    }
  }
  ...
  return (
    ...
    >
      ...
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Nueva Clase Especial</DialogTitle>
          <DialogDescription>
            Crear una nueva clase especial mensual. Completa los campos requeridos.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input id="title" name="title" required placeholder="Ej: Mindfulness y Relajación" />
            </div>
            <div className="space-y-2">
